...
public class PDAO {
    ...
    public void Insert(PModel Model){
        try{
            String query = "INSERT INTO pegawai VALUES (NULL,'"+Model.getId()+"','"+Model.getNama()+"','"+Model.getPosisi()+"','"+Model.getAlamat()+"','"+Model.getNohp()+"','"+Model.getGajipokok()+"','"+Model.getLembur()+"','"
                    +Model.getTunjangan()+"','"+Model.getPajak()+"','"+Model.getTotalgaji()+"')";
...
//    public void Update(PModel Model) {
//        try{
...
//    }
//    
//    public void Delete(PModel Model) {
//        try{
...
//    public String[][] Search(PModel Model){
//        try{
//            int jmlData = 0; //menampung jmlh data
//            //baris sejumlah data, kolomnya ada 3
